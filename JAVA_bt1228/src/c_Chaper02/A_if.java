...
// 조건문 (Condition)
// : 프로그램의 흐름을 제어하는데 사용되는 기본적인 구조 중 하나
...
//		: 조건은 true / false의 결과를 반환하는 boolean 형태의 표션식 
...
//			age 변수에는 19 이하의 수만 작성 가능
			if (age <=13)
//				첫번째 조건이 참이고 두번째 조건도 참인 코드
				System.out.println("어린이입니다");
		} else {
//			첫번째 조건이 참이고 두번째 조건은 거짓인 코드 블럭
//			13 초과 19미만 값
...
//		: if 문 뒤에 나오며, 여러개를 연속해서 사용 가능
		
		if(age>19) {
			System.out.println("성인입니다");
//		별도의 조건을 가지는 문장으로
//		첫번째 조건은 거짓이면서 두번째 조건은 참인 문장을 실행
		} else if (age <=13) {
			System.out.println("어린이입니다");
//		모든 조건식이 거짓일때 실행
		} else {
